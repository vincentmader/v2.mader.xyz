...
pub fn step(
    ...
    for interaction in interactions.iter() {
        ...
        let get_force = match interaction {
            InteractionVariant::NewtonianGravity => newtonian_gravity::force, // TODO rename
            InteractionVariant::Coulomb => coulomb::force,
            InteractionVariant::LennardJones => lennard_jones::force,
